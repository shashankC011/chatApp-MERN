...
const LoginPage = ()=>{
    ...
    const validateForm= ()=>{
        ...
        if (/\s/.test(formData.password)) return toast.error("Password cannot contain whitespace");
        return true;
    }
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex flex-col items-center gap-2 group">
                            ...
                            <p className="text-base-content/60">Sign in below</p>
                        </div>
                    </div>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button type="submit" className="btn btn-primary w-50" disabled={isLoggingIn}>{isLoggingIn?
